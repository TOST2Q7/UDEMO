...
echo -e " BR-RTR forwards 172.16.2.2:$APP_PORT here; once ${YELLOW}gost.sh${NC} (HQ-SRV)"
echo -e " and ${YELLOW}gost-isp.sh${NC} (ISP) have run, open https://docker.au-team.irpo"
echo -e " from HQ-CLI."
