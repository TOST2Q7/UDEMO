...
echo -e " (both hosts already have the key/cert files waiting in ~/,"
echo -e "  delivered by this script)"
echo
echo -e " On ISP:"
echo -e "   wget -O gost-isp.sh $(dirname "$RAW_URL")/gost-isp.sh"
echo -e "   chmod +x gost-isp.sh"
echo -e "   ./gost-isp.sh"
echo
echo -e " On HQ-CLI:"
echo -e "   wget -O gost-hqcli.sh $(dirname "$RAW_URL")/gost-hqcli.sh"
echo -e "   chmod +x gost-hqcli.sh"
echo -e "   ./gost-hqcli.sh"
echo -e "${CYAN}============================================================${NC}"
echo
